...
<div id="searchCategoryArea">

<ul class="categoryListo18 clearfix">

<li class="emailRequest"><a href="{$base}/search_friend_mail">通过邮件地址检索</a></li>
<li class="schoolSearch"><a href="{$base}/search_school">通过学校名称检索</a></li>
<li class="companySearch"><a href="{$base}/search_company">通过公司名称检索</a></li>
<li class="profileSearch"><a href="{$base}/search_profile">通过个人信息检索</a></li>
<li class="addressSearch"><a href="{$base}/list_contacts">根据邮件地址簿检索</a></li>
<li class="keywordSearch"><a href="{$base}/search_mykeyword">通过关键字检索</a></li>
</ul>

<!--/searchCategoryArea--></div>
