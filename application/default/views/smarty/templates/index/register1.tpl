...
<form name="regForm" id="regForm" action="{$base}/register1com" method="post">
<div id="editList01">

<div class="heading16">
<h2>Totu社区用户个人信息登录<em> (全体项目都是必须的)</em></h2>
<p class="headingLink"><span class="LayerInfo"><a tabindex="-1" href="{$base}/register_help" class="POPUP_REL_ELEMENT" target="" rel="openlevelhelp">关于公开范围 [?]</a></span></p>
</div>
...
<li>
<dl>
<dt><label for="nickname">昵称</label> <span class="LayerInfo"><a tabindex="-1" href="{$base}/register_help" class="POPUP_REL_ELEMENT" target="" rel="nicknamehelp">[?]</a></span></dt>
...
<li>
<dl>
<dt>名前 <span class="LayerInfo"><a tabindex="-1" href="{$base}/register_help" class="POPUP_REL_ELEMENT" target="" rel="namehelp">[?]</a></span></dt>
<dd>
...
<dt>現住所</dt>
<dd>
<p class="editItem01"><input name="location_change" type="hidden"><select class="" name="location_pref" id="locationPref" tabindex="5"  validate="form" require="<p>请选择您所处的省直辖市。</p>"><option value="">▼省直辖市</option>{foreach from=$allprovinces|smarty:nodefaults item="item"}<option value="{$item.id}">{$item.name}</option>{/foreach}</select>
<select class="" name="location_area" id="locationArea" tabindex="6"><option value="">▼市县</option>{foreach from=$allcitys|smarty:nodefaults item="item"}<option value="{$item.id}">{$item.name}</option>{/foreach}</select>
...
<li>
<dl>
<dt>生日 <span class="LayerInfo"><a tabindex="-1" href="{$base}/register_help" class="POPUP_REL_ELEMENT" target="" rel="birthdayhelp">[?]</a></span></dt>
<dd>
<p class="editItem01">
...
<li>
<dl>
<dt>出生年份 <span class="LayerInfo"><a tabindex="-1" href="{$base}/register_help" class="POPUP_REL_ELEMENT" target="" rel="birthdayhelp">[?]</a></span></dt>
<dd>
<p class="editItem01">
...
<li>
<dl>
<dt>登录邮件地址 <span class="LayerInfo"><a tabindex="-1" href="{$base}/register_help" class="POPUP_REL_ELEMENT" target="" rel="emailhelp">[?]</a></span></dt>
<dd><p>{$email}</p>
...
<li>
<dl>
<dt><label for="password1">登录密码</label> <span class="LayerInfo"><a tabindex="-1" href="{$base}/register_help" class="POPUP_REL_ELEMENT" target="" rel="passwordhelp">[?]</a></span></dt>
...
同意<a href="{$base}/rules" target="_blank">使用规则</a>、<a href="{$base}/privacy" target="_blank">个人隐私信息保护条约</a>中的内容。<br>
