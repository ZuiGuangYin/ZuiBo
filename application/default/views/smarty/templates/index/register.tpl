...
<!--[UserInputArea]-->
<form action="{$base}/registercom" method="post"  name="regForm" id="regForm" >
<div class="userInputArea">
<div class="heading16"><h3>输入邮件地址</h3></div>
<div class="contents">
<div class="inner inputEmail">
<h4>欢迎注册成为Tobu社区的会员</h4>

<p>注册是免费的。<br>在Tobu社区中不仅能让你找到您很久没有联系的朋友，而且能结交到许多新朋友。</p>

<h5>请输入邮件地址：</h5>

<p class="registEmail">
<input id="anonymous_element_1" onFocus="this.value='';" name="email" size="20" class="PLACEHOLDER email defaultText" value="请输入您经常使用的邮件地址" title="请输入您经常使用的邮件地址" type="text" {literal}maxlength="200" validate="form" require="</p>请输入电子邮件地址。</p>" regular="<p>请检查输入的邮件地址的形式。</p><p>例）example@address.com</p>" validExpress="[a-zA-Z0-9!#$%&'*+/=?^_`{|}~-]+(?:\.[a-zA-Z0-9!#$%&'*+/=?^_`{|}~-]+)*@(?:[a-zA-Z0-9](?:[a-zA-Z0-9-]*[a-zA-Z0-9])?\.)+[a-zA-z0-9](?:[a-zA-Z0-9-]*[a-zA-Z0-9])?" />{/literal}

<span class="supplement01">输入的邮件地址将会在您登录本社区时使用。</span>
<span class="supplement01">※在您确认了<a href="{$base}/rule" target="_blank">使用规则</a>、<a href="{$base}/privacy" target="_blank">个人隐私信息保护条款</a>后、请点击下面的按钮。</span></p>
<input name="postkey" value="26b9772d803b10b327a8f82ceee0a222459209a1" type="hidden">
<p class="formButtons01"><input   value="同意并开始注册" type="button" onclick="checkEmail()"></p>

</div>
<p class="supplement01">※您输入的邮件地址将会用于接受社区相关更新信息，以及用于接受如果有其他朋友发给您信息时的系统提示。</p>
</div>

<!--/userInputArea--></div>
<!--/[UserInputArea]-->

<!--/registrationArea--></form></div>
<!--/[RegistrationArea]-->
