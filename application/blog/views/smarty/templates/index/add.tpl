...
<dt>照片</dt>
<dd>
<p>第1枚<input size="35" name="photo1" type="file"></p>
<p>第2枚<input size="35" name="photo2" type="file"></p>
<p>第3枚<input size="35" name="photo3" type="file"></p>
...
<input name="backurl" value="addblog" type="hidden">
